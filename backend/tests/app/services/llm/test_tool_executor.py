...
class TestToolExecutor:
    ...
    async def test_execute_tool_calls_with_execution_id(self):
        ...
        with patch.object(
            ...
            results = await executor.execute_tool_calls(
                [tool_call], execution_id="exec_12345"
            )
    ...
    async def test_tool_result_serialization(self):
        ...
        for i, expected_result in enumerate(test_cases):
            ...
            with patch.object(
                executor.registry, "get_tool_function", return_value=mock_func
            ):
                tool_call = ToolCall(
                    id=f"call_{i}",
                    type="function",
    ...
    async def test_tool_execution_with_complex_arguments(self):
        ...
        complex_args = {
            "user": {"name": "John", "age": 30, "preferences": ["option1", "option2"]},
        ...
        with patch.object(
            ...
            tool_call = ToolCall(
                ...
                type="function",
                function=ToolCallFunction(
                    name="complex_tool", arguments=json.dumps(complex_args)
                ),
            )
    ...
    async def test_tool_arguments_not_dict(self):
        ...
        with patch.object(
            ...
            tool_call = ToolCall(
                ...
                type="function",
                function=ToolCallFunction(
                    name="test_tool", arguments='["not", "a", "dict"]'
                ),
            )
