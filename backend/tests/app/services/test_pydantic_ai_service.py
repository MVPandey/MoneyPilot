...
class TestPydanticAIService:
    ...
    def test_init_with_defaults(self, mock_settings, mock_model_class, mock_provider_class):
    ...
    @patch.dict("os.environ", {"LLM_API_BASE_URL": "https://env.api.com", "LLM_API_KEY": "env-key"})
    @patch("app.services.pydantic_ai_service.OpenAIProvider")
    @patch("app.services.pydantic_ai_service.OpenAIModel")
    @patch("app.services.pydantic_ai_service.app_settings")
    def test_init_with_env_vars(self, mock_settings, mock_model_class, mock_provider_class):
    ...
    @patch("app.services.pydantic_ai_service.OpenAIProvider")
    @patch("app.services.pydantic_ai_service.OpenAIModel")
    def test_create_agent_default(self, mock_model_class, mock_provider_class, mock_agent_class):
    ...
    @patch("app.services.pydantic_ai_service.OpenAIProvider")
    @patch("app.services.pydantic_ai_service.OpenAIModel")
    def test_create_agent_with_overrides(self, mock_model_class, mock_provider_class, mock_agent_class):
    ...
    @patch("app.services.pydantic_ai_service.OpenAIProvider")
    @patch("app.services.pydantic_ai_service.OpenAIModel")
    async def test_run_success(self, mock_model_class, mock_provider_class, mock_agent_class):
    ...
    @patch("app.services.pydantic_ai_service.OpenAIProvider")
    @patch("app.services.pydantic_ai_service.OpenAIModel")
    async def test_run_without_context(self, mock_model_class, mock_provider_class, mock_agent_class):
    ...
    @patch("app.services.pydantic_ai_service.OpenAIProvider")
    @patch("app.services.pydantic_ai_service.OpenAIModel")
    async def test_run_with_exception(self, mock_model_class, mock_provider_class, mock_agent_class):
    ...
    @patch("app.services.pydantic_ai_service.OpenAIProvider")
    @patch("app.services.pydantic_ai_service.OpenAIModel")
    async def test_run_stream_success(self, mock_model_class, mock_provider_class, mock_agent_class):
    ...
    @patch("app.services.pydantic_ai_service.OpenAIProvider")
    @patch("app.services.pydantic_ai_service.OpenAIModel")
    async def test_run_stream_with_exception(self, mock_model_class, mock_provider_class, mock_agent_class):
...
class TestSimpleAgent:
    ...
    @patch("app.services.pydantic_ai_service.OpenAIProvider")
    @patch("app.services.pydantic_ai_service.OpenAIModel")
    def test_create_agent_with_parameters(self, mock_model_class, mock_provider_class, mock_agent_class):
        """Test create_agent with parameters."""
        agent = SimpleAgent(
            system_prompt="Hello {name}, you are in {location}"
        )
    ...
    @patch("app.services.pydantic_ai_service.OpenAIProvider")
    @patch("app.services.pydantic_ai_service.OpenAIModel")
    def test_create_agent_without_parameters(self, mock_model_class, mock_provider_class, mock_agent_class):
    ...
    @patch("app.services.pydantic_ai_service.OpenAIProvider")
    @patch("app.services.pydantic_ai_service.OpenAIModel")
    async def test_run_with_parameters(self, mock_model_class, mock_provider_class, mock_agent_class):
        """Test run with parameters."""
        agent = SimpleAgent(
            system_prompt="Assistant for {user_type}",
            output_type=OutputModel
        )
        ...
        result = await agent.run(
            "Test prompt",
            parameters={"user_type": "developer"}
        )
    ...
    @patch("app.services.pydantic_ai_service.OpenAIProvider")
    @patch("app.services.pydantic_ai_service.OpenAIModel")
    async def test_run_stream_with_parameters(self, mock_model_class, mock_provider_class, mock_agent_class):
        """Test run_stream with parameters."""
        agent = SimpleAgent(
            system_prompt="Stream for {mode}"
        )
    ...
    @patch("app.services.pydantic_ai_service.OpenAIProvider")
    @patch("app.services.pydantic_ai_service.OpenAIModel")
    async def test_backward_compatibility(self, mock_model_class, mock_provider_class, mock_agent_class):
    ...
    @patch("app.services.pydantic_ai_service.OpenAIProvider")
    @patch("app.services.pydantic_ai_service.OpenAIModel")
    async def test_run_with_kwargs(self, mock_model_class, mock_provider_class, mock_agent_class):
